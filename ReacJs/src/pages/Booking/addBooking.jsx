          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            ...
            <div>
              ...
              <TimePicker
                ...
                locale="en-GB"
                clearIcon={null}
                className={`react-time-picker w-full ${errors.checkInTime ? 'border-red-500' : 'border-gray-300'
            ...
            <div>
              ...
              <TimePicker
                ...
                locale="en-GB"
                clearIcon={null}
                className={`react-time-picker w-full ${errors.checkOutTime ? 'border-red-500' : 'border-gray-300'
                  } border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500`}
              />
              {errors.checkOutTime && (
